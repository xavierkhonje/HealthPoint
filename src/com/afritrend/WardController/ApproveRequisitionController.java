...
import com.afritrend.PharmacyController.PharmacyDrugApprovalModalController;
...
public class ApproveRequisitionController implements Initializable {
    ...
    public void ApproveVoucher(ActionEvent event)
    {
        ...
        try
        {
            ...
            {
                PharmacyApprovalModal(voucher.getVouchercode());
            }
    ...
    public void PharmacyApprovalModal(String voucherNumber)
    {
        try
        {
            FXMLLoader fxloader = new FXMLLoader(getClass().getResource("/com/afritrend/Pharmacy/PharmacyDrugApprovalModal.fxml"));
            Parent root = fxloader.load();
            
            PharmacyDrugApprovalModalController controller = fxloader.<PharmacyDrugApprovalModalController>getController();                      
